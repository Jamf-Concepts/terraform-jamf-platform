...
resource "jamfplatform_pro_icon" "ios_apple_app" {
  for_each = {
...
resource "jamfplatform_pro_icon" "ios_jamf_self_service" {
  for_each = {
...
resource "jamfplatform_pro_icon" "ios_microsoft_office" {
  for_each = {
...
resource "jamfplatform_pro_mobile_device_app" "apple_app" {
  for_each = {
    for idx, result in data.itunessearchapi_content.ios_apple_apps.results : result.track_id => result
  ...
  self_service = {
    ...
    self_service_icon = {
      id = jamfplatform_pro_icon.ios_apple_app[each.key].id
    }
  }
  ...
  scope = {
    targets = {
      department_ids = [
        jamfplatform_pro_department.common["marketing"].id
      ]
    }
  }
}

resource "jamfplatform_pro_mobile_device_app" "jamf_self_service" {
  for_each = {
    for idx, result in data.itunessearchapi_content.ios_jamf_self_service.results : result.track_id => result
  }
  ...
  self_service = {
    ...
    self_service_icon = {
      id = jamfplatform_pro_icon.ios_jamf_self_service[each.key].id
    }
  }
...
resource "jamfplatform_pro_mobile_device_app" "microsoft_office" {
  for_each = {
    for idx, result in data.itunessearchapi_content.ios_microsoft_office_apps.results : result.track_id => result
    if result.track_name != null
  }
  ...
  self_service = {
    ...
    feature_on_main_page     = true
    self_service_icon = {
      id = jamfplatform_pro_icon.ios_microsoft_office[each.key].id
    }
  }
