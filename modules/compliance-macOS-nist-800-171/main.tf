...
resource "jamfpro_category" "category_tahoe_800_171_benchmarks" {
...
resource "jamfpro_script" "script_tahoe_800_171_compliance" {
...
resource "jamfpro_smart_computer_group" "group_tahoe_computers" {
...
resource "jamfpro_smart_computer_group" "group_tahoe_800_171_non_compliant" {
...
resource "jamfpro_policy" "policy_tahoe_800_171_audit" {
  name            = "NIST 800-171 - Audit (Tahoe)"
  enabled         = true
  trigger_checkin = true
  frequency       = "Ongoing"
  category_id     = jamfpro_category.category_tahoe_800_171_benchmarks.id

  scope {
    all_computers      = false
    computer_group_ids = [jamfpro_smart_computer_group.group_tahoe_computers.id]
  }
  ...
  payloads {
    scripts {
      id         = jamfpro_script.script_tahoe_800_171_compliance.id
      parameter4 = "--check"
    }
...
resource "jamfpro_policy" "policy_tahoe_800_171_remediation" {
  ...
  scope {
    all_computers      = false
    computer_group_ids = [jamfpro_smart_computer_group.group_tahoe_800_171_non_compliant.id]
  }
...
locals {
  tahoe_800_171_dict = {
    "Accessibility"         = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-Accessibility.mobileconfig"
    "Application Access"    = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-applicationaccess.mobileconfig"
    "Assistant Support"     = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-assistant.support.mobileconfig"
    "Disc Recording"        = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-DiscRecording.mobileconfig"
    "Dock"                  = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-dock.mobileconfig"
    "Apple IR Controller"   = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-driver.AppleIRController.mobileconfig"
    "Finder"                = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-finder.mobileconfig"
    "Global Preferences"    = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-GlobalPreferences.mobileconfig"
    "iCloud"                = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-icloud.managed.mobileconfig"
    "Login Window"          = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-loginwindow.mobileconfig"
    "MCX"                   = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-MCX.mobileconfig"
    "MCX Bluetooth"         = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-MCXBluetooth.mobileconfig"
    "mDNS Responder"        = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-mDNSResponder.mobileconfig"
    "Password Policy"       = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-mobiledevice.passwordpolicy.mobileconfig"
    "Photos Shared Defauts" = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-photos.shareddefaults.mobileconfig"
    "Screen Saver"          = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-screensaver.mobileconfig"
    "Firewall"              = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-security.firewall.mobileconfig"
    "Setup Assistant"       = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-SetupAssistant.managed.mobileconfig"
    "Submit Diag Info"      = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-SubmitDiagInfo.mobileconfig"
    "System Policy Control" = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-systempolicy.control.mobileconfig"
    "Managed System Policy" = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-systempolicy.managed.mobileconfig"
    "System Preferences"    = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-systempreferences.mobileconfig"
    "Managed Client"        = "${path.module}/support_files/computer_config_profiles/Tahoe_800-171-timed.mobileconfig"
  }
}

## Create configuration profiles for Tahoe
resource "jamfpro_macos_configuration_profile_plist" "tahoe_800_171" {
  ...
  depends_on = [jamfpro_macos_configuration_profile_plist.sequoia_800_171]
}

resource "jamfpro_macos_configuration_profile_plist" "tahoe_800_171_smart_card" {
