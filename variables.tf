## Define Jamf Platform provider variables (populated by .tfvars file)
variable "jamfplatform_base_url" {
  description = "Regional API gateway URL (e.g. https://us.apigw.jamf.com)."
  type        = string
}

variable "jamfplatform_client_id" {
  description = "OAuth2 client ID from account.jamf.com Integration."
  type        = string
}

variable "jamfplatform_client_secret" {
  description = "OAuth2 client secret from account.jamf.com Integration."
  type        = string
  sensitive   = true
}
